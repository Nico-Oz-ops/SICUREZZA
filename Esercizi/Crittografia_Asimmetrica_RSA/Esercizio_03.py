...
msg_int = int.from_bytes(messaggio.encode(), "big")
...
# Questa sequenza serve a trasformare un numero intero decifrato (RSA) in una stringa originale:
# numero intero (decifra) → sequenza di byte → stringa leggibile

try:
    if messaggio == decifra_str:
